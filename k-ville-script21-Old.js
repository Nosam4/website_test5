...
{value: 'TJ Power' , datadecade: 2020 , datastart: 2023 , datayears: 1 , dataposition: 'F' , dataheight: 609 , datanumber: 12, gamemode: 'easy', fact: '5-Star Recruit', InstaUsername: '@TJPower14' , InstaURL: 'https://twitter.com/tjpower14?lang=en'},
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //// Haptic Feedback Buttons -- End

  function triggerHapticFeedback() {
    if ("vibrate" in navigator) {
        // Vibration pattern: a single 50ms vibration
        navigator.vibrate(50);
    }
}

// Add event listeners to buttons
document.querySelectorAll('#button-container-left button, #button-container-right button, #guess-button-grid button, #timer, #how-to-play, #dropDownArrow').forEach(button => {
    button.addEventListener('click', triggerHapticFeedback);
});


    //// Haptic Feedback Buttons -- Start